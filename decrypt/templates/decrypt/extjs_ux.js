...
HT.ux.plugins.Export = Ext.extend(Object, {
    constructor: function (a) {
        Ext.apply(this, a);
        HT.ux.plugins.Export.superclass.constructor.call(this, a);
    },
    init: function (b) {
...
HT.ux.plugins.Print = Ext.extend(Object, {
    constructor: function (a) {
        Ext.apply(this, a);
        HT.ux.plugins.Print.superclass.constructor.call(this, a);
    },
    init: function (b) {
...
HT.PagingBar = Ext.extend(Ext.PagingToolbar, {
    constructor: function (b) {
        ...
        if (b.exportable) {
            ...
            a.plugins.push(new HT.ux.plugins.Export(c));
        }
        if (b.printable) {
            a.plugins.push(new HT.ux.plugins.Print());
        }
        Ext.apply(a, b);
        HT.PagingBar.superclass.constructor.call(this, a);
    }
});
HT.JsonStore = Ext.extend(Ext.data.JsonStore, {
    constructor: function (a) {
        ...
        Ext.applyIf(b, a);
        HT.JsonStore.superclass.constructor.call(this, b);
    }
});
HT.initGridConfig = function (b) {
    if (!b.store) {
        b.store = new HT.JsonStore({
            url: b.url,
            fields: b.fields,
    ...
    if (b.exportable && !b.setPagingBar) {
        ...
        b.plugins.push(new HT.ux.plugins.Export(d));
    }
    var a = {
        store: b.store
    };
    ...
    var g = new HT.PagingBar(a);
    if (b.printable) {
        b.plugins.push(new HT.ux.plugins.Print());
    }
    var e = {
        shim: true,
        trackMouseOver: true,
...
HT.GridPanel = Ext.extend(Ext.grid.GridPanel, {
    constructor: function (a) {
        var b = HT.initGridConfig(a);
        HT.GridPanel.superclass.constructor.call(this, b);
    }
});
...
HT.initDataViewConfig = function (a) {
    if (!a.store) {
        a.store = new HT.JsonStore({
            url: a.url,
            fields: a.fields,
...
HT.DataView = Ext.extend(Ext.DataView, {
    constructor: function (a) {
        var b = HT.initDataViewConfig(a);
        HT.DataView.superclass.constructor.call(this, b);
    }
});
...
HT.FormPanel = Ext.extend(Ext.form.FormPanel, {
    constructor: function (a) {
        ...
        Ext.apply(b, a);
        HT.FormPanel.superclass.constructor.call(this, b);
    }
});
            ...
            for (n = 0; n < j; n += 1) {
                ...
                switch (typeof m) {
                    ...
                    default:
                        ...
                        k.push(m === null ? "null" : HT.JSON.encode(m));
                        h = true;
                }
            }
            k.push("]");
...
HT.HBoxPanel = Ext.extend(Ext.Panel, {
    constructor: function (b) {
        ...
        Ext.apply(a, b);
        HT.HBoxPanel.superclass.constructor.call(this, a);
    }
});
